...
Source0  : https://www.fltk.org/pub/fltk/1.3.5/fltk-1.3.5-source.tar.bz2
...
%prep
%setup -q -n fltk-1.3.5
cd %{_builddir}/fltk-1.3.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590689698
...
cp %{_builddir}/fltk-1.3.5/COPYING %{buildroot}/usr/share/package-licenses/fltk/804b2d61c0867ff1b0b0cb5648970d5aba808713
cp %{_builddir}/fltk-1.3.5/documentation/src/license.dox %{buildroot}/usr/share/package-licenses/fltk/ed64c0250faa1fc40311e0bf1a2f4fba654beaad
cp %{_builddir}/fltk-1.3.5/png/LICENSE %{buildroot}/usr/share/package-licenses/fltk/ff48ba33080ba25f8b499d09b47cd9679dde252f
cp %{_builddir}/fltk-1.3.5/src/xutf8/COPYING %{buildroot}/usr/share/package-licenses/fltk/93fd5552183411097c82fa6032cab1142ae7887b
cp %{_builddir}/fltk-1.3.5/src/xutf8/lcUniConv/COPYRIGHT %{buildroot}/usr/share/package-licenses/fltk/d9fcea34224bf0b199bd29e6f25d0280f5e05ca8
%make_install
