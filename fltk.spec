...
Source0  : https://www.fltk.org/pub/fltk/1.3.9/fltk-1.3.9-source.tar.gz
...
%prep
%setup -q -n fltk-1.3.9
cd %{_builddir}/fltk-1.3.9
%patch -P 1 -p1
pushd ..
cp -a fltk-1.3.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719962862
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfltk.so.1.3
/V3/usr/lib64/libfltk_forms.so.1.3
/V3/usr/lib64/libfltk_gl.so.1.3
/V3/usr/lib64/libfltk_images.so.1.3
